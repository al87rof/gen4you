<?php
/**
 * Description of Aquabitcoin
 *
 * @author Sanja
 */
class Aquabitcoin extends AFaucet {
    /*
    ...
    public function parseCaptcha() {
        ...
        if (($result['errno'] != 0 ) || ($result['http_code'] != 200)) {
            ...
            $res2 = explode("<div class=\"text-center\">", $res[2]);
            return $res2[0];
        }
    }
    ...
    public function parseCaptchaValid() {
       ...
       // echo $page;
        ...
        if(isset($res22[1])){
            $res_1 = explode("<div class=\"alert alert-danger\">", $page);
            $res_2 = explode("</div>", $res_1[1]);
            return $res_2[0];    
        }
